...
import { Config, FareProductSelector, GradationMap, Itinerary, Leg, LegIconComponent, Place, Stop, TransitOperator } from "@opentripplanner/types";
...
export declare type ToRouteAbbreviationFunction = (route: string | number) => string;
...
export declare type TimeColumnContentProps = LegDestination;
/**
...
export declare type SetActiveLegFunction = (legIndex: number, leg: Leg) => void;
export declare type FrameLegFunction = (args: LegSharedProps & {
    place: Place;
}) => void;
...
export declare type SetViewedTripFunction = (tripSection: TripSection) => void;
...
export interface PlaceRowProps extends ItineraryBodySharedProps, LegSharedProps {
    /** Indicates whether this leg directly follows a transit leg */
    followsTransit?: boolean;
    followsStopover?: boolean;
}
