...
export default function PlaceRow(_ref) {
  var followsStopover = _ref.followsStopover,
      accessibilityScoreGradationMap = _ref.accessibilityScoreGradationMap,
  ...
  return /*#__PURE__*/React.createElement(S.PlaceRowWrapper, {
    ...
    "aria-hidden": true
  }, (!followsStopover || isDestination) && /*#__PURE__*/React.createElement(PlaceName, {
    config: config,
    interline: interline,
    place: place
