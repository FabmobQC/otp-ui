...
export var CO2Description = styled.span.withConfig({
  displayName: "styled__CO2Description",
  componentId: "sc-6q2ok2-1"
})([""]);
export var CO2Summary = styled.span.withConfig({
  displayName: "styled__CO2Summary",
  componentId: "sc-6q2ok2-2"
})([""]);
export var ExpandButton = styled(BaseButton).withConfig({
...
export var TripDetailsHeader = styled.h2.withConfig({
