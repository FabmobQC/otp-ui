...
exports.StoryMapContainer = exports.LayerSelector = exports.LeafletStyleMarker = exports.PopupTitle = exports.PopupRow = exports.MapOverlayPopup = exports.Popup = void 0;
 ...
 */
const LeafletStyleMarker = _styledComponents.default.div.withConfig({
  displayName: "styled__LeafletStyleMarker",
  componentId: "sc-12kjso7-4"
})(["background:", "50;border-radius:", "px;border:", "px solid ", ";content:\"\";cursor:pointer;display:block;height:", "px;width:", "px;"], props => (props === null || props === void 0 ? void 0 : props.color) || "#0000ff", props => (props === null || props === void 0 ? void 0 : props.size) || 10, props => (props === null || props === void 0 ? void 0 : props.stroke) || 2, props => (props === null || props === void 0 ? void 0 : props.strokeColor) || `${props === null || props === void 0 ? void 0 : props.color}f0` || "#0000fffo", props => (props === null || props === void 0 ? void 0 : props.size) || 10, props => (props === null || props === void 0 ? void 0 : props.size) || 10);

exports.LeafletStyleMarker = LeafletStyleMarker;

const LayerSelector = _styledComponents.default.aside.withConfig({
...
const StoryMapContainer = _styledComponents.default.div.withConfig({
  displayName: "styled__StoryMapContainer",
  componentId: "sc-12kjso7-6"
})(["height:90vh;"]);

exports.StoryMapContainer = StoryMapContainer;
