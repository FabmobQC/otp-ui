...
export default function GeneralSettingsPanel(_ref) {
  ...
  return /*#__PURE__*/React.createElement(S.GeneralSettingsPanel, {
    ...
    if (!(paramInfo !== null && paramInfo !== void 0 && paramInfo.routingTypes.includes(query.routingType))) return null; // Check that the applicability test (if provided) is satisfied
