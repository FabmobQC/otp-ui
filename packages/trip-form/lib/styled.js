...
exports.SettingsSelectorPanel = exports.GeneralSettingsPanel = exports.SliderSelector = exports.DropdownSelector = exports.ModeButton = exports.SubmodeSelector = exports.ModeSelector = exports.DateTimeSelector = exports.FloatingSettingLabel = exports.SettingLabel = exports.SettingsSection = exports.SettingsHeader = void 0;
...
const SliderSelector = _styledComponents.default.div.withConfig({
  displayName: "styled__SliderSelector",
  componentId: "sc-122ziys-18"
})(["> div{align-items:center;box-sizing:border-box;display:inline-flex;gap:10px;position:relative;width:100%;> label{display:block;white-space:pre;}}input{box-sizing:border-box;cursor:pointer;width:100%;}"]);
