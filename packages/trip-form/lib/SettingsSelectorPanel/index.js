...
function SettingsSelectorPanel({
  ...
  }), /*#__PURE__*/_react.default.createElement(S.SettingsHeader, null, settingsHeader), selectedModes.some(isTransit) && transitModes.length >= 2 && /*#__PURE__*/_react.default.createElement(_SubmodeSelector.default, {
    label: submodeLabel,
    modes: transitModes,
