 ...
 */
export default function DateTimeSelector({ className, date, dateFormatLegacy, departArrive, forceLegacy, onQueryParamChange, style, time, timeFormatLegacy, timeZone }: DateTimeSelectorProps): ReactElement;
export {};
