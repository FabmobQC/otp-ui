...
function DateTimeSelector({
  ...
  const handleTimeChangeLegacy = (0, _react.useCallback)(evt => {
    const newTime = (0, _dateFns.format)((0, _dateFns.parse)(evt.target.value, timeFormatLegacy, referenceDate), OTP_API_TIME_FORMAT);
    handleQueryParamChange({
      newTime
    });
  }, [onQueryParamChange]);
  const handleDateChangeLegacy = (0, _react.useCallback)(evt => {
    const newDate = (0, _dateFns.format)((0, _dateFns.parse)(evt.target.value, dateFormatLegacy, referenceDate), OTP_API_DATE_FORMAT);
    handleQueryParamChange({
      newDate
    });
  }, [onQueryParamChange]);
  ...
  return /*#__PURE__*/_react.default.createElement(S.DateTimeSelector, {
    ...
    defaultValue: (0, _dateFns.format)((0, _dateFns.parse)(time, OTP_API_TIME_FORMAT, referenceDate), timeFormatLegacy),
    onChange: handleTimeChangeLegacy,
    required: true,
    type: "text"
  })), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("input", {
    defaultValue: (0, _dateFns.format)((0, _dateFns.parse)(date, OTP_API_DATE_FORMAT, referenceDate), dateFormatLegacy),
