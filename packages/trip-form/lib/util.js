...
function getTransitCombinedModeOptions(ModeIcon, modes, selectedModes, selectedCompanies, supportedCompanies) {
  ...
  return accessModes && accessModes.map(modeObj => {
    ...
    return {
      ...
      text: /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement(_react.Suspense, {
        fallback: company || "Loading..."
      }, /*#__PURE__*/_react.default.createElement(ModeIcon, {
        mode: "TRANSIT"
      }), "+", finalIcon)),
      title: modeLabel
    };
...
function getCompaniesOptions(companies, modes, selectedCompanies) {
  return getCompanies(companies, modes).map(comp => {
    ...
    return {
      ...
      text: /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement(_react.Suspense, {
        fallback: comp.label || comp.id || "Loading"
      }, CompanyIcon ? /*#__PURE__*/_react.default.createElement(CompanyIcon, null) : comp.id)),
      title: comp.label
    };
  });
}
