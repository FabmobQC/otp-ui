...
exports.default = generateModeButtonLabel;
exports.generateModeSettingLabels = generateModeSettingLabels;
...
function generateModeButtonLabel(key, intl, defaultLabel) {
  switch (key.toLocaleLowerCase()) {
    ...
    default:
      return intl.formatMessage({
        defaultMessage: defaultLabel || defaultMessages[`otpUi.ModeSelector.labels.${key}`],
...
function generateMainSettingLabel(key, intl) {
  switch (key) {
    ...
    default:
      return intl.formatMessage({
        defaultMessage: defaultMessages[`otpUi.ModeSelector.settings.${key}-label`],
...
function generateSliderLabels(key, intl) {
  switch (key) {
    ...
    default:
      return {
        labelLow: intl.formatMessage({
          defaultMessage: defaultMessages[`otpUi.ModeSelector.settings.${key}-labelLow`],
          description: `Metro Mode Selector Slider Label High (${key})`,
          id: `otpUi.ModeSelector.settings.${key}-labelLow`
        }),
        labelHigh: intl.formatMessage({
          defaultMessage: defaultMessages[`otpUi.ModeSelector.settings.${key}-labelHigh`],
...
function generateModeSettingLabels(type, key, intl, defaultLabel) {
  switch (type) {
    case "SLIDER":
      return {
