  ...
  return (
    ...
    _react.default.createElement(S.ScrollableRow, {
      ...
      const onChangeMode = () => {
        ...
        let mode = (0, _util.getCategoryPrimaryMode)(category); // If the category has a single mode select companies from all
        // options, if the category has mixed modes select the company
        // (if any) associated with first option

        const companies = (category.mode ? (_category$options = category.options) === null || _category$options === void 0 ? void 0 : _category$options.map(o => o.company).join(",") : (_category$options2 = category.options) === null || _category$options2 === void 0 ? void 0 : (_category$options2$ = _category$options2[0]) === null || _category$options2$ === void 0 ? void 0 : _category$options2$.company) || "";
