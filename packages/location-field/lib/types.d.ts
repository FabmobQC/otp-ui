...
export declare type LocationType = "from" | "to" | `intermediate-place-${number}` | `additional-place-${number}`;
export declare type ResultType = "CURRENT_LOCATION" | "GEOCODE" | "SAVED" | "SESSION" | "STOP";
...
export declare type UserLocationIconType = ComponentType<UserLocationIconProps>;
export interface LocationFieldProps {
     ...
     * ```
     */
    clearLocation?: ({ locationType: LocationType }: {
        locationType: any;
    }) => void;
    /**
...
export declare type UserLocationSelectedHandler = (newLocation: Location, resultType: ResultType) => void;
